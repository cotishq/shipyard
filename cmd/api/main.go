...
func main() {
	...
	secured.POST("/deployments/:id/retry", api.RetryDeployment)
	secured.POST("/deployments/:id/cancel", api.CancelDeployment)
	secured.POST("/deployments/:id/redeploy", api.RedeployDeployment)
